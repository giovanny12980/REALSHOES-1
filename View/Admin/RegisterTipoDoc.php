        ...
        <main>
            ...
            <div class='shadow'>
                <form action='' method='post' style='padding: 10px; margin:10px'>
                    <h3 style='padding: 10px; margin:10px; text-align: center;'class ='text-success'>Registro de Tipo de Documento</h3>
                    ...
                    <div class='input-group mb-3 input-group mb-3'>
                        <input class='btn btn-primary' type='submit' value='Registrar Documento' name='registrar' style='float: right;'>
                    </div>
                </form>
            </div>
